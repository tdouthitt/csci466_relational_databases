...
$sql = "SELECT IT.DEPARTURE_PORT,IT.DEPARTURE_DATE,PO.PORT_NAME,PO.COUNTRY FROM ITINERARY IT,PORTS PO WHERE IT.PORT_ID =PO.PORT_ID AND IT.DEPARTURE_DATE ='$_POST[SearchDate]'";
